	...
	class AuditLog
	{
		...
		public static function actionLabels()
		{
			return [
				...
				'user.status_updated' => 'Доступ пользователя изменён',
				'user.session_revoked' => 'Сессия пользователя завершена',
				'user.sessions_revoked' => 'Сессии пользователя завершены',
				...
				'media.trashed' => 'Медиа перемещено в корзину',
				'media.restored' => 'Медиа восстановлено из корзины',
				'media.purged' => 'Медиа удалено окончательно',
				'customers.exported' => 'Пользователи сайта выгружены в CSV',
				'customers.updated' => 'Профиль пользователя сайта изменён',
				'customers.deleted' => 'Пользователь сайта удалён',
				'customers.status_changed' => 'Доступ пользователя сайта изменён',
				'customers.auth_settings_updated' => 'Настройки публичной регистрации изменены',
				'customers.auth_pages_updated' => 'Страницы публичной авторизации изменены',
				'customers.auth_form_updated' => 'Шаблон публичной авторизации изменён',
				'customers.auth_form_reset' => 'Шаблон публичной авторизации сброшен',
				'auth.public_login_failed' => 'Неудачная попытка публичного входа',
				'commerce.orders_exported' => 'Заказы выгружены в CSV',
				'popups.leads_exported' => 'Заявки из поп-апов выгружены в CSV',
				'quiz.created' => 'Подбор товара создан',
				'quiz.updated' => 'Подбор товара изменён',
				'quiz.deleted' => 'Подбор товара удалён',
				'quiz.leads_exported' => 'Заявки подбора выгружены в CSV',
				'popups.campaign_created' => 'Кампания поп-апа создана',
				'popups.campaign_updated' => 'Кампания поп-апа изменена',
				'popups.campaign_deleted' => 'Кампания поп-апа удалена',
				'popups.lead_status_changed' => 'Статус заявки поп-апа изменён',
				'popups.settings_updated' => 'Настройки поп-апов изменены',
				'antispam.ip_blocked' => 'Антиспам заблокировал адрес',
				...
				'document.bulk_editor_completed' => 'Массовое изменение документов завершено',
				...
				'commerce.order_claimed' => 'Заказ принят менеджером в работу',
				...
				'comments.updated' => 'Комментарий изменён',
				'comments.moderated' => 'Статус комментария изменён',
				'comments.bulk_moderated' => 'Комментарии обработаны массово',
				'comments.settings_updated' => 'Настройки комментариев изменены',
				'comments.thread_updated' => 'Состояние обсуждения изменено',
				'todo.created' => 'Задача Todo создана',
				'todo.updated' => 'Задача Todo изменена',
				'todo.completed' => 'Задача Todo выполнена',
				'todo.reopened' => 'Задача Todo возвращена в работу',
				'todo.deleted' => 'Задача Todo удалена',
				'kanban.created' => 'Карточка канбана создана',
				'kanban.updated' => 'Карточка канбана изменена',
				'kanban.deleted' => 'Карточка канбана удалена',
				'ratings.vote_deleted' => 'Оценка удалена модератором',
				'ratings.target_reset' => 'Рейтинг объекта сброшен',
				'reviews.bulk_moderated' => 'Отзывы обработаны массово',
				...
				'auth.login_succeeded' => 'Вход в панель выполнен',
				'auth.login_failed' => 'Неудачная попытка входа',
				'auth.password_changed' => 'Временный пароль изменён',
