...
Если установлен **Планировщик**, он показывает выключенную по умолчанию
пошаговую задачу **Переиндексация похожих материалов**. Её можно запустить
вручную либо включить расписание; прогресс сохранится между тиками.
